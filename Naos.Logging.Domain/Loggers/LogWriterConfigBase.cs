...
namespace Naos.Logging.Domain
{
    ...
    public abstract class LogWriterConfigBase
    {
        ...
        /// </summary>
        public IReadOnlyDictionary<LogItemKind, IReadOnlyCollection<LogItemOrigin>> LogInclusionKindToOriginsMap { get; private set; }
        ...
        public virtual bool ShouldLog(LogItemKind logItemKind, LogItemOrigin logItemOrigin)
        {
            ...
            LogItemOrigin logItemOrigin)
        {
            ...
            var hasKey = logInclusionKindToOriginsMap.TryGetValue(logItemKind, out IReadOnlyCollection<LogItemOrigin> origins);
